...
describe("PowerPlatformIR fixtures", () => {
  ...
  it("serializes fixture deterministically", async () => {
    ...
    expect(serializeDeterministicIR(payload)).toMatchInlineSnapshot(
      `"{"analysisSummary":{"attributes":0,"canvasApps":0,"canvasBlockedControls":0,"canvasComplexFormulas":0,"canvasControls":0,"canvasControlsByRole":{},"canvasFormulas":0,"canvasLayoutWarnings":0,"canvasScreens":0,"canvasScreensByReadiness":{"blocked":0,"high":0,"low":0,"medium":0},"canvasUnknownControls":0,"choices":0,"classifiedFiles":0,"connectionReferences":0,"entities":0,"environmentVariables":0,"filesScanned":0,"flowActions":0,"flowConnectorsDetected":0,"flowPremiumCustomConnectors":0,"flows":0,"flowsByReadiness":{"blocked":0,"high":0,"low":0,"medium":0},"flowTriggers":0,"relationships":0,"securityRoles":0,"solutionMetadataPresence":false,"unknownFiles":0,"unresolvedDependencies":0,"unresolvedFlowDependencies":0,"unsupportedFeatures":0,"unsupportedFlowFeatures":0,"warnings":0},"canvasApps":[],"cloudFlows":[],"confidence":1,"connectionReferences":[],"dataverse":{"entities":[],"optionSets":[],"relationships":[]},"dependencyGraph":{"edges":[]},"environmentVariables":[],"provenance":{"sourcePath":"unknown-solution","sourceType":"solution"},"security":{"roles":[]},"solution":{"artifactId":"solution:default","confidence":1,"localizedNames":[],"managed":false,"name":"Unknown Solution","provenance":{"sourcePath":"unknown-solution","sourceType":"solution"},"publisher":{"displayName":"Unknown Publisher","uniqueName":"unknown_publisher"},"sourceFolder":"unknown-solution","uniqueName":"unknown_solution","version":"0.0.0"},"unsupportedFeatures":[],"warnings":[]}"`
    );
  });
});
